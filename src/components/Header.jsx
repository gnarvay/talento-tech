    ...
    <div className="container">
      ...
      <div className="nav-scroller py-1 mb-3 border-bottom">
        <nav className="nav nav-underline justify-content-between">
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Categorías:</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Fantasma</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Siniestro</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Eléctrico</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Psíquico</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Fuego</Link>
          <Link className="nav-item nav-link link-body-emphasis" to={"/"}>Volador</Link>
        </nav>
      </div>
